...
export function ServiceCard({ service }: { service: Service }) {
  return (
    <Card className="group flex flex-col border-white/8 bg-[#1E1E1E] transition-all duration-300 hover:border-gold-500/40 hover:shadow-[0_0_30px_rgba(201,162,39,0.08)]">
      <CardHeader>
